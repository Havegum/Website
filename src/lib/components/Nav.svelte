...
<nav class="nav py-0 -mb-3">
  <ul class="flex flex-row justify-center p-0 m-0" on:blur={timeout} on:mouseout={timeout}>
    <li>
      <a
        class:selected={$page.route.id === '/about' || $page.route.id === '/om-meg'}
      ...
      >
        ...
        <p class="m-0 absolute top-1/2 left-0 right-0 text-center transform -translate-y-1/2">
    ...
    <li>
      <a
        class:selected={$page.route.id?.startsWith('/blog')}
